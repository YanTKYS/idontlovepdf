...
`idontlovepdf-engine` v0.2.0 の正式Release bundleを同梱し、ブラウザ上で次まで成立することを確認した段階である。

- PDFの選択
- エンジンの読み込み
- PDF本文テキストの認識

本文の検索・置換・保存を一般職員向けUIとして提供するのは次の段階とする。
